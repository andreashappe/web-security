...
- ARGS: beschreibt auf welchen Bereich (z. B. auf welchen Parameter) eine
jeweilige Operation angewendet werden soll.

- OPERATOR: definiert die Abfrage/den Filter der auf die ARGS angewandt werden
soll.

- ACTIONS: beschreibt die Aktivitäten (z. B. blockieren und loggen) die angewandt
...
4. Was ist der Grundgedanke dabei, DevOps und Security zu verbinden?

5. Welche Sicherheitsmaßnahmen können im Zuge von SecDevOps
